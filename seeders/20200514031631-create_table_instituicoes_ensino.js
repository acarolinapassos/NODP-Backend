...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('instituicoes_ensino', [
      ...
      { descricao: 'Universidade Federal do Rio de Janeiro', estado_id: 20, sigla: 'NI' },
      { descricao: 'Universidade Estadual Paulista Júlio de Mesquita Filho', estado_id: 26, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal do Paraná', estado_id: 17, sigla: 'NI' },
      { descricao: 'Universidade de Brasília UNB', estado_id: 7, sigla: 'UNB' },
      { descricao: 'Universidade Federal Fluminense', estado_id: 20, sigla: 'NI' },
      { descricao: 'Universidade Federal da Bahia', estado_id: 5, sigla: 'NI' },
      { descricao: 'Universidade Federal de São Paulo UNIFESP', estado_id: 26, sigla: 'UNIFESP' },
      { descricao: 'Universidade Federal do Ceará', estado_id: 6, sigla: 'NI' },
      { descricao: 'Universidade do Estado do Rio de Janeiro UERJ', estado_id: 20, sigla: 'UERJ' },
      { descricao: 'Universidade Federal de Pernambuco', estado_id: 18, sigla: 'NI' },
      { descricao: 'Pontificia Universidade Católica do Rio de Janeiro PUC-RIO', estado_id: 20, sigla: 'PUC-RIO' },
      { descricao: 'Universidade Federal do Rio Grande do Norte', estado_id: 21, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal de São Carlos', estado_id: 17, sigla: 'NI' },
      ...
      { descricao: 'Universidade Estadual de Maringá', estado_id: 17, sigla: 'NI' },
      { descricao: 'Universidade Federal da Paraíba UFPB', estado_id: 16, sigla: 'UFPB' },
      { descricao: 'Universidade Estadual de Londrina', estado_id: 17, sigla: 'NI' },
      { descricao: 'Universidade Federal de Viçosa UFV', estado_id: 17, sigla: 'UFV' },
      { descricao: 'Universidade Federal de Uberlândia', estado_id: 14, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal do Espírito Santo', estado_id: 8, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal de Campina Grande', estado_id: 26, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal de Mato Grosso do Sul', estado_id: 13, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal de Mato Grosso', estado_id: 12, sigla: 'NI' },
      { descricao: 'Universidade Federal de São João del Rei UFSJ', estado_id: 26, sigla: 'UFSJ' },
      { descricao: 'Universidade Presbiteriana Mackenzie', estado_id: 26, sigla: 'NI' },
      { descricao: 'Universidade Federal de Sergipe UFS', estado_id: 27, sigla: 'UFS' },
      { descricao: 'Universidade Federal do Maranhão', estado_id: 11, sigla: 'NI' },
      ...
      { descricao: 'Universidade Estácio de Sá', estado_id: 26, sigla: 'NI' },
      { descricao: 'Universidade Estadual do Oeste do Paraná UNIOSTE', estado_id: 17, sigla: 'UNIOSTE' },
      { descricao: 'Universidade Católica de Brasilia', estado_id: 7, sigla: 'NI' },
      { descricao: 'Universidade de Passo Fundo', estado_id: 17, sigla: 'NI' },
      ...
      { descricao: 'Universidade Nove de Julho', estado_id: 17, sigla: 'NI' },
      { descricao: 'Universidade de Caxias do Sul', estado_id: 17, sigla: 'NI' },
      { descricao: 'Universidade Estadual da Paraíba UEPB', estado_id: 16, sigla: 'UEPB' },
      { descricao: 'Universidade Metodista de São Paulo', estado_id: 26, sigla: 'NI' },
      { descricao: 'Universidade Estadual do Ceará', estado_id: 6, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal Rural da Amazônia', estado_id: 4, sigla: 'NI' },
      ...
      { descricao: 'Universidade Federal de Alagoas', estado_id: 2, sigla: 'NI' },
      { descricao: 'Senac Serviço Nacional de Aprendizagem Comercial', estado_id: 26, sigla: 'NI' },
      ...
      { descricao: 'Universidade de Pernambuco', estado_id: 18, sigla: 'NI' },
      ...
      { descricao: 'Universidade Estadual do Norte Fluminense Darcy Ribeiro', estado_id: 20, sigla: 'NI' },
      ...
      { descricao: 'Universidade Veiga de Almeida', estado_id: 26, sigla: 'NI' },
      { descricao: 'Universidade Federal de Rondônia', estado_id: 26, sigla: 'NI' },
